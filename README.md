...
This guide shows you how to set up an alternate layout with Kanata, run Kanata in the background on startup, and edit the layout. The list of [example configs](#example-configs) shows you what Kanata can do.
