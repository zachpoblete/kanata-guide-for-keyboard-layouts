...
-   Instead of downloading the [`example-config.kbd`](configs/example-config.kbd) file, download one of the example configs from the [Example configs](#example-configs) section of this guide.
    ...
    1.  Click <picture><source media="(prefers-color-scheme: dark)" srcset="resources\github-download-raw-file-icon-light.svg"><img alt="" src="resources\github-download-raw-file-icon-dark.svg"></picture>
    **Download raw file**.
