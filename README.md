...
1.  If you’re using a non-[US keyboard](https://commons.wikimedia.org/wiki/File:Qwerty.svg#/media/File:Qwerty.svg) and Kanata isn’t remapping a key, the name of the key might not be correct. See [How to get the name of a key](docs/key-names.md#how-to-get-the-name-of-a-key).
