...
**To stop Kanata, press the key combination `Left Control + Space + Escape`.** Use the physical keys in those positions&mdash;it doesn’t matter what you configured those keys to do.
