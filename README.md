...
This guide shows you how to set up an alternate layout with Kanata, run Kanata on startup, and edit the layout. The [example configs](#example-configs) show what Kanata can do.
